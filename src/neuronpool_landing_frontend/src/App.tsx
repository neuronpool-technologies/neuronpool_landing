          ...
          <VStack gap={{ base: 10, md: 12 }}>
            ...
            >
              ...
              <UseCaseCard
                ...
                description="Automate maturity distribution and cycles management with NTC integration. Mint vectors convert ICP to cycles, while redeem vectors distribute cycles across multiple canisters."
                features={[
